...
# 可视化 price 的系数
plt.figure(figsize=(10, 6))
plt.scatter(coords_sample[:, 0], coords_sample[:, 1], 
            c=results.params[:, 1], cmap='coolwarm', s=20)  # minimum_nights系数
plt.colorbar(label="Minimum Nights Coefficient")
plt.xlabel("Longitude")
plt.ylabel("Latitude")
plt.title("Spatial Distribution of Minimum Nights Coefficient")
plt.show()
```
