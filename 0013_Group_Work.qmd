...
### Logistic Regression: What Factors Drive Policy Violations?
...
***Results***
Key property and host characteristics were identified as drivers of policy violations, with all variables showing statistical significance (p < 0.001). However, the model’s low pseudo R-squared (0.05) highlights limited explanatory power.

Residual analysis and Moran’s I test (I = 0.0855, p = 0.001) revealed weak but significant spatial patterns, suggesting missing factors and unexplained spatial heterogeneity. Further refinement is needed to improve the model's accuracy.
