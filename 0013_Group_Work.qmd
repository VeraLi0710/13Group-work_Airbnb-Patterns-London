...
The GWR model shows strong explanatory power, explaining over 80% of the variation in non-compliant listings across most of London (R-squared ≥ 0.8), and 95% in central areas where they are concentrated (R-squared = 0.95).  
The GWR model shows strong explanatory power, explaining over 80% of the variation in non-compliant listings across most of London (R-squared ≥ 0.8) and up to 95% in central areas where these listings are concentrated (R-squared = 0.95). The most influential factors include public transport density and tourist attraction density.
