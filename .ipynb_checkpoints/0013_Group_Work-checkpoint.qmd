...
1. **Spatial Patterns**:  
   Airbnb listings are concentrated in central London, particularly in high-demand, high-rent areas (Figure 1, Map). Entire-home rentals dominate these areas, making them hotspots for non-compliance with the 90-day rule.  

2. **Booking Days and Non-Compliance Risks**:  
   Estimated booking days, calculated using reviews, pricing, and minimum nights [@insideairbnb], show that entire homes and hotel-like properties frequently exceed the 90-day limit, posing significant enforcement challenges (Figure 1, Panel 1).  

To address the limitations of using only snapshot data, we merged datasets from December 2023 to September 2024 and removed duplicates to ensure greater accuracy (Figure 2)：
...
3. **Host Characteristics**:  
   Multi-listing hosts make up 62.38% of all listings and have higher average booking durations (75.17 days) compared to single-listing hosts (66.61 days) (Figure 2, Top Left). Heatmaps (Figure 2) indicate that these hosts primarily manage entire homes and hotel-like properties, which have higher prices and shorter minimum stays, reflecting increased commercialization.  

4. **Property Types**:  
   Entire homes dominate the market, comprising 66.97% of listings and averaging the longest booking durations (78.38 days), making them the most likely to exceed the 90-day limit (Figure 2, Top Right). Hotel-like properties, though less common, also exhibit highly commercial trends, with the shortest minimum stays (2.13 nights) (Figure 2, heatmap). Private rooms and shared spaces are less commercialized, showing lower booking durations and pricing, making them less likely to violate the rule.  
